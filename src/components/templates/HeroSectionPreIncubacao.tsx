...
const HeroSectionPreIncubacao = () => {
  ...
  "
        ...
        <div className="mb-6 flex justify-center px-4">
          <div className="max-w-2xl rounded-2xl bg-white/70 backdrop-blur-md border-orange-400/40 ring-2 ring-orange-400/50 px-0 sm:px-4 py-6 shadow-lg">
            ...
            <p className="mt-3 text-center text-base sm:text-lg text-gray-700 leading-relaxed">
              ...
              <br />O programa oferece mentorias, capacitação e acompanhamento
              técnico para transformar ideias inovadoras em startups prontas
              para validação e crescimento.
            </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-10 mt-10 justify-center items-center">
          <Button
            ...
            onClick={() =>
              window.open(
                "https://ifsertaope.edu.br/editais/edital-n-45-2026-processo-de-selecao-para-o-programa-de-pre-incubacao-sertao-inovador/",
                "_blank",
              )
            }
          >
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                "https://forms.gle/iCRhfNZiiTXmh1WY9",
                "_blank",
              )
            }
          >
