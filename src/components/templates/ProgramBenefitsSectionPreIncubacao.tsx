    ...
    <section id="beneficios" className="py-20  bg-background/10 scroll-mt-19">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto mb-20">
          ...
          {/* Audio Player */}
          <AudioPlayer
            src="https://res.cloudinary.com/dds7llxbd/video/upload/v1775083778/Sert%C3%A3o_Inovador_valida_startups_sem_cobrar_equity_adp0iu.mp4"
            title="Sertão Inovador: Validação de startups sem cobrar Equity"
          />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <p className="max-w-4xl mx-auto text-black sm:text-lg text-center mt-10 leading-relaxed text-black/90 font-regular drop-shadow-md">
            Abaixo está um vídeo que apresenta o Programa de
            Pré-Incubação Sertão Inovador 2026.1, explicando seus objetivos,
            benefícios e como ele funciona.
          </p>
...
export default ProgramBenefitsSectionPreIncubacao;
