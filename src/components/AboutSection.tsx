  ...
  const features = [
    {
      ...
      title: "Impacto Local",
      description:
        "Focamos em soluções que atendam às necessidades específicas do Sertão Central brasileiro.",
    },
    {
      icon: Users,
      title: "Ecossistema Colaborativo",
      description:
        "Conectamos empreendedores, mentores, investidores e parceiros locais.",
    },
    {
      icon: Lightbulb,
      title: "Inovação Sustentável",
      description:
        "Promovemos tecnologias que respeitam o meio ambiente e a cultura local.",
    },
    {
      icon: TrendingUp,
      title: "Crescimento Escalável",
      description:
        "Preparamos startups para crescer além das fronteiras regionais.",
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            A Incubadora Sertão Maker é uma iniciativa que conecta inovação,
            empreendedorismo e impacto social no sertão nordestino. Atuamos no
            apoio ao desenvolvimento de startups com soluções sustentáveis,
            inclusivas e tecnológicas, transformando desafios regionais em
          ...
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              ...
              <strong className="text-foreground">
                {" "}
                laboratórios do Centro de Inovação Maker
              </strong>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="p-6 text-center bg-gradient-card border-border/50">
              ...
              <p className="text-muted-foreground">
                Espaço equipado para desenvolvimento e testes de soluções em
                Internet das Coisas, automação e hardware.
              </p>
            </Card>
            ...
            <Card className="p-6 text-center bg-gradient-card border-border/50">
              ...
              <p className="text-muted-foreground">
                Prototipagem rápida de produtos físicos, peças funcionais e
                validação de ideias.
              </p>
            </Card>
            ...
            <Card className="p-6 text-center bg-gradient-card border-border/50">
              ...
              <p className="text-muted-foreground">
                Ambiente estruturado para gravação de podcasts, vídeos
                institucionais e produção de conteúdo das startups.
              </p>
            </Card>
          </div>
        </div>
